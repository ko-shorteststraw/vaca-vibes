...
- **Itinerary Planning** -- Add, edit, and delete daily activities with times, descriptions, and costs. Inline editing with cancel support
...
| Infrastructure | Docker Compose (nginx + PHP-FPM), Railway single-container |
